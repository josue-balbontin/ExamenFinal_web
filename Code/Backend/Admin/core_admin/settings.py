...
env_path = BASE_DIR.parent.parent / '.env.development'
...
SECRET_KEY = 'django-insecure-zue(lk_#&1(e6+t7aawgdtr_leaxc-$hg(qro3d&d==@&0kjkc'
...
AUTHENTICATION_BACKENDS = [
    'panel.backends.CustomUsuarioBackend',
